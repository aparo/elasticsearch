...
/* Paro added copy */
  public FieldType copy(){
      FieldType dest=new FieldType();
      dest.stored=this.stored;
      dest.indexed=this.indexed;
      dest.tokenized=this.tokenized;
      dest.storeTermVectors=this.storeTermVectors;
      dest.storeTermVectorOffsets=this.storeTermVectorOffsets;
      dest.storeTermVectorPositions=this.storeTermVectorPositions;
      dest.omitNorms=this.omitNorms;
      dest.indexOptions=this.indexOptions;
      dest.numericType=this.numericType;
      dest.numericPrecisionStep=dest.numericPrecisionStep;
      dest.docValueType=dest.docValueType;
      return dest;
  }
