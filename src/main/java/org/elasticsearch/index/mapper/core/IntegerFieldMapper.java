...
public class IntegerFieldMapper extends NumberFieldMapper<Integer> {
    ...
    protected IntegerFieldMapper(Names names, int precisionStep, String fuzzyFactor, boolean index, boolean tokenize, boolean store,
    ...
    @Override
    public Integer value(IndexableField field) {
    ...
    public String indexedValue(String value) {
        ...
        NumericUtils.intToPrefixCoded(Integer.parseInt(value), 0, bytesRef);
