...
public class LongFieldMapper extends NumberFieldMapper<Long> {
    ...
    protected LongFieldMapper(Names names, int precisionStep, String fuzzyFactor, boolean index, boolean tokenize, boolean store,
    ...
    public String indexedValue(String value) {
        ...
        NumericUtils.longToPrefixCoded(Long.parseLong(value), 0, bytesRef);
