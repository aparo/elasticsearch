...
public class GeoDistanceRangeFilter extends Filter {
    ...
    public DocIdSet getDocIdSet(AtomicReaderContext atomicReaderContext, Bits bits) throws IOException {
        ...
        if (boundingBoxFilter != null) {
            DocIdSet docIdSet = boundingBoxFilter.getDocIdSet(atomicReaderContext, bits);
            if (docIdSet == null) {
                return null;
            }
            boundingBoxDocSet = DocSets.convert(atomicReaderContext.reader(), docIdSet);
        }
        ...
        GeoDistanceRangeDocSet distDocSet = new GeoDistanceRangeDocSet(atomicReaderContext.reader().maxDoc(), fieldData, fixedSourceDistance, distanceBoundingCheck, inclusiveLowerPoint, inclusiveUpperPoint);
