...
public class ValueDateHistogramFacetCollector extends AbstractFacetCollector {
    ...
    protected void doSetNextReader(AtomicReaderContext readerContext) throws IOException {
        keyFieldData = (LongFieldData) fieldDataCache.cache(keyFieldDataType, readerContext.reader(), keyIndexFieldName);
        histoProc.valueFieldData = (NumericFieldData) fieldDataCache.cache(valueFieldDataType, readerContext.reader(), valueIndexFieldName);
    }
