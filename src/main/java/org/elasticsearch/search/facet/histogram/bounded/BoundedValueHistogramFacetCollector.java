...
public class BoundedValueHistogramFacetCollector extends AbstractFacetCollector {
    ...
    protected void doSetNextReader(AtomicReaderContext readerContext) throws IOException {
        keyFieldData = (NumericFieldData) fieldDataCache.cache(keyFieldDataType, readerContext, keyIndexFieldName);
        histoProc.valueFieldData = (NumericFieldData) fieldDataCache.cache(valueFieldDataType, readerContext, valueIndexFieldName);
    }
