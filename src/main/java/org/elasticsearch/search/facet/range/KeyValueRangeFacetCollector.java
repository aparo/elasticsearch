...
public class KeyValueRangeFacetCollector extends AbstractFacetCollector {
    ...
    protected void doSetNextReader(AtomicReaderContext readerContext) throws IOException {
        keyFieldData = (NumericFieldData) fieldDataCache.cache(keyFieldDataType, readerContext.reader(), keyIndexFieldName);
        rangeProc.valueFieldData = (NumericFieldData) fieldDataCache.cache(valueFieldDataType, readerContext.reader(), valueIndexFieldName);
    }
